...
def one_fold_evaluate(df,y,train_idx,test_idx,methods,result_df,fold):
...
def evaluate_disease(df, y, methods,time_spilt):
    ...
    if time_spilt:
        ...
        one_fold_evaluate(df,y,train_idx,test_idx,methods,result_df,1)
        return result_df
    else:
        ...
        for fold, (train_id, test_id) in enumerate(kf.split(df[y == 1].index)):
            ...
            one_fold_evaluate(df,y,train_idx,test_idx,methods,result_df,fold)                    
        return result_df
