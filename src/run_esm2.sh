...
python main_reindex_time.py "esm2" "results/esm2_2019_bootstrap_full" 2019
python main_reindex_time.py "esm2" "results/esm2_2017_bootstrap_full" 2017

# python main_reindex_time_uniport_2019.py "uniport" "results/uniport_2019_full" 2019
