...
# python main_rf.py 'uniport_ppi_2019,ppi_2019_dw_40,uniport_bio,uniport_seq,uniport_esm,diffusion_2019_2' "results/2019_rf_after10_early" 2019 > 2019_rf_after10_early.log 2>&1
# python main_rf.py 'uniport_ppi_2019,ppi_2019_dw_40,uniport_bio,uniport_seq,uniport_esm,diffusion_2019_2' "results/2019_rf_after10_early" 2019 > 2019_rf_after10_early_temp.log 2>&1
