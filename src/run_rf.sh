...
python main_rf.py 'uniport_ppi_2019,ppi_2019_dw_40,uniport_bio,uniport_seq,uniport_esm,diffusion_2019_2' "results/2019_rf_after10" 2019 > 2019_rf_after10.log 2>&1
