...
def one_fold_evaluate(disease, time, feature_list, df,y,train_idx,test_idx,methods,result_df,fold):
    ...
    if 'random_negative' in methods:
        ...
        # kernel_dir_path = '/itf-fi-ml/shared/users/ziyuzh/svm/results/df_early_kernel'
        kernel_dir_path = '/itf-fi-ml/shared/users/ziyuzh/svm/results/df_early_ppi_kernel'
