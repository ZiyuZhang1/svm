...
from model_gnn_ori_copy_improvedsage import neg_bagging_gcn, neg_bagging_sage, eval_bagging
...
def main():
    ...
    if test_bug:
        ...
        out_path = os.path.join(root, 'results/2019_gnn_ori_copy_improvedsage')
