...
# disgenet
python main_all_fused.py 'uniport_ppi_2019,ppi_2019_dw_40,uniport_bio,uniport_seq,uniport_esm' "results/2019_all_fused" 2019 'disgenet' > 2019_all_fused.log 2>&1
