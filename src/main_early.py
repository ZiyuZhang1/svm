...
from model_early import evaluate_disease
import pickle
import sys
...
if test_bug:
    ...
    # out_path = os.path.join(root,'results/df_early')
    out_path = os.path.join(root,'results/df_early_ppi')
...
merged_df = get_feature(root, feature_list[0])
