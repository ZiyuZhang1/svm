...
if test_bug:
    ...
    feature_list = ['ppi_2017_dw_10','ppi_2017_dw_40','ppi_2017_dw_80','uniport_exp','uniport_seq','uniport_esm']
    out_path = os.path.join(root,'results/ppi_2017_dw_test_scale')
