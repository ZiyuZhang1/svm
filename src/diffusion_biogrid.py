...
for setting in ['2019']:
    ...
    save_dir = f'/itf-fi-ml/shared/users/ziyuzh/svm/results/df_biogrid/{setting}'
    os.makedirs(save_dir, exist_ok=True)


    with open('/itf-fi-ml/shared/users/ziyuzh/svm/results/df_biogrid/2019_map.pkl', 'rb') as f:
