...
for time in ['2016','2019']:
    edge_path = '/itf-fi-ml/shared/users/ziyuzh/svm/data/ppi_full_'+time+'.txt'
    for num_walks_per_node in [10,40,80]:
        out_path = '/itf-fi-ml/shared/users/ziyuzh/svm/data/ppi_full_'+time+'_dw_emb_'+str(num_walks_per_node)+'.txt'
